...
| Nama | NIM | Peran |
|---|---|---|
| _(Nama anggota 1)_ | _(NIM)_ | _(Peran, mis. Project Lead / Backend)_ |
| _(Nama anggota 2)_ | _(NIM)_ | _(Peran, mis. UI/UX & Frontend)_ |
| _(Nama anggota 3)_ | _(NIM)_ | _(Peran, mis. Persistence & Testing)_ |
| _(Nama anggota 4)_ | _(NIM)_ | _(Peran, mis. Documentation & QA)_ |

> Lengkapi tabel di atas sebelum penyerahan laporan akademik.

---

## Lisensi

Proyek ini dirilis untuk keperluan pembelajaran akademik. Lihat berkas `LICENSE` jika tersedia, atau sesuaikan dengan kebijakan kelas Anda.
